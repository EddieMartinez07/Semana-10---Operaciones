...
class Program
{
    static void Main()
    {
        ...
        HashSet<int> todosUsuarios = new HashSet<int>(Enumerable.Range(1, 500));

        // Crear un conjunto ficticio de 75 usuarios vacunados con Pfizer
        HashSet<int> usuariosPfizer = new HashSet<int>(Enumerable.Range(1, 75));

        // Crear un conjunto ficticio de 75 usuarios vacunados con Astrazeneca
        HashSet<int> usuariosAstrazeneca = new HashSet<int>(Enumerable.Range(76, 75));

        // Conjunto de usuarios vacunados (Pfizer o Astrazeneca)
        HashSet<int> usuariosVacunados = new HashSet<int>(usuariosPfizer);
